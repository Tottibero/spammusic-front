<template>
    <div class="p-4 min-h-screen bg-gray-50/50">
        <div class="max-w-7xl mx-auto">
            <h1 class="text-2xl font-bold mb-4 text-gray-800">Videos Riff Valley</h1>

            <!-- Listas Actuales -->
            <section class="mb-6">
                <div class="flex items-center gap-2 mb-3">
                    <div class="p-1.5 bg-indigo-100 rounded-lg">
                        <i class="fa-solid fa-video text-indigo-600 text-lg"></i>
                    </div>
                    <h2 class="text-xl font-bold text-gray-800">Actuales</h2>
                </div>

                <div v-if="currentLists.length > 0"
                        ...
                        <div class="p-3 flex-1 flex flex-col">
                            ...
                            <div class="mt-auto space-y-2">
                                ...
                                <div class="space-y-1 py-2 border-t border-gray-100">
                                    ...
                                    <div v-if="list.closeDate"
                                        class="flex items-center text-xs text-red-600 font-medium">
                ...
                <div v-else class="bg-white rounded-lg p-6 text-center border-2 border-dashed border-gray-200">
                    ...
                    <p class="text-sm text-gray-500">Las nuevas listas de videos aparecerán aquí.</p>
                </div>
            </section>
...
import { getCurrentVideoLists, getPastVideoLists } from '@services/list/list';
...
async function loadCurrentLists() {
    try {
        currentLists.value = await getCurrentVideoLists();
    } catch (error) {
...
async function loadPastLists() {
    try {
        pastLists.value = await getPastVideoLists(selectedYear.value);
    } catch (error) {
